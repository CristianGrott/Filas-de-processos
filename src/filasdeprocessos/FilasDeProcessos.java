        ...
        do{
            ...
            switch (escalona){
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Prioridade.prioridade(n_processos, processo_ID, tempo_chegada, prioridade, tempo_execucao, tempo_restante, tempTot);
                    break;
                case 5:
                    Round_Roben.roundRoben(processo_ID, tempo_restante, tempo_chegada,tempo_execucao, timeSlice, tempTot);
                    break;
                default:
